...
export default function Dashboard() {
  ...
  className={`flex-1 md:flex-initial flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-sm tracking-wide transition-all ${
    selected === "meal"
      ? "bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-xl shadow-emerald-900/20 scale-[1.02]"
      : "bg-neutral-900 border border-white/5 hover:border-emerald-500/30 text-gray-400 hover:text-white"
  }`}
>
  ...
  <span>AI Meal Analyzer</span>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <p className="text-gray-400 font-mono text-xs tracking-widest uppercase animate-pulse">
              Syncing Nutritional Matrix...
            </p>
          </div>
        )}
            ...
            {diets.length === 0 ? (
              <div className="text-center py-16 bg-neutral-900/40 border border-white/5 rounded-3xl p-8 max-w-md mx-auto">
                ...
                <h3 className="text-lg font-bold mb-2">
                  No Active Diet Engine Plans
                </h3>
                <p className="text-sm text-gray-400 mb-6">
                  Fetch your personalized macro allocations directly from your
                  coach database.
                </p>
                <button
                  onClick={getDiets}
                  className="bg-red-600 hover:bg-red-700 font-semibold px-6 py-3 rounded-xl text-sm transition-all"
                >
                  Initialize Sync
                </button>
              </div>
                    ...
                    <div>
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-xs text-gray-500 font-mono">
                          ID: {diet.diet_docid?.substring(0, 5)}...
                        </span>
                      </div>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                  <div>
                    ...
                    <h2 className="text-3xl sm:text-4xl font-black tracking-tight">
                      {currentDiet.planName}
                    </h2>
                    <p className="text-gray-400 text-sm mt-1">
                      Caloric Target Engine Objective:{" "}
                      <span className="text-white font-medium">
                        {currentDiet.goal}
                      </span>
                    </p>
                  ...
                  {[
                    {
                      ...
                      val: `${currentDiet.summary?.dailyCalories} kcal`,
                      desc: "Total Energy Stream",
                      icon: Flame,
                      color: "text-orange-400 bg-orange-500/5",
                    },
                    {
                      label: "Anabolic Protein",
                      val: `${currentDiet.summary?.protein}g`,
                      desc: "Muscle Tissue Growth",
                      icon: Dumbbell,
                      color: "text-red-400 bg-red-500/5",
                    },
                    {
                      label: "Glycogen Carbs",
                      val: `${currentDiet.summary?.carbs}g`,
                      desc: "High Energy Reserve",
                      icon: Sparkles,
                      color: "text-blue-400 bg-blue-500/5",
                    },
                    {
                      label: "Lipids / Fats",
                      val: `${currentDiet.summary?.fats}g`,
                      desc: "Hormone Regulation",
                      icon: ShieldCheck,
                      color: "text-yellow-400 bg-yellow-500/5",
                    },
                    {
                      label: "Water Volumizer",
                      val: `${currentDiet.summary?.waterLiters} Liters`,
                      desc: "Hydration Intake",
                      icon: Droplet,
                    ...
                    <div
                      key={idx}
                      className="bg-neutral-950/40 border border-white/5 p-4 sm:p-5 rounded-2xl flex flex-col justify-between"
                    >
                      <div className="flex items-center justify-between gap-2 mb-4">
                        <span className="text-[10px] font-mono tracking-wide text-gray-400 uppercase leading-none">
                          {stat.label}
                        </span>
                        <stat.icon
                          className={`w-4 h-4 ${stat.color} p-0.5 rounded`}
                        />
                      </div>
                      <div>
                        ...
                        <span className="text-[10px] text-gray-500 font-light block leading-none">
                          {stat.desc}
                        </span>
                      </div>
                    </div>
                  ...
                  {currentDiet.meals?.map((meal, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          onClick={() =>
                            setExpandedMeal(isExpanded ? null : idx)
                          }
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <div className="flex items-center gap-2 flex-wrap">
                                <h4 className="text-lg font-black tracking-tight text-white group-hover:text-red-400 transition-colors">
                                  {meal.mealName}
                                </h4>
                            ...
                            >
                              <div className="p-5 sm:p-6 grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                                ...
                                <div className="space-y-4">
                                  <h5 className="text-xs font-mono text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                                    // Recipe Telemetry
                                  </h5>
                                  ...
                                  <h5 className="text-xs font-mono text-gray-400 uppercase tracking-widest pt-2 flex items-center gap-1.5">
                                  ...
                                  <div className="flex flex-wrap gap-1.5">
                                    {meal.foods?.map((food, fIdx) => (
                                      <span
                                        key={fIdx}
                                        className="text-[11px] font-mono capitalize px-2.5 py-1 bg-neutral-950 text-gray-400 border border-white/5 rounded-md"
                                      >
                                        {food}
                                      </span>
                                    ))}
                                ...
                                <div>
                                  <h5 className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-1.5">
                                ...
                                <div className="md:col-span-2 lg:col-span-1 space-y-2">
                                  <h5 className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-1.5">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-5 sm:p-6 backdrop-blur-md">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h4 className="font-black text-md text-white tracking-tight">
                        AI Shopping List Depot
                      </h4>
                    </div>
                    <div className="space-y-1.5 max-h-[16rem] overflow-y-auto pr-1">
                      {currentDiet.shoppingList?.map((item, idx) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            className="accent-red-600 rounded border-white/20 bg-neutral-900 w-3.5 h-3.5 flex-shrink-0"
                          />
                  ...
                  <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-5 sm:p-6 backdrop-blur-md">
                    ...
                    <p className="text-gray-500 text-[11px] font-light leading-relaxed mb-4">
                      Recommended catalytic enhancers to maximize post-workout
                      nitrogen retention.
                    </p>
                    <div className="space-y-2">
                      {currentDiet.supplements?.map((supp, sIdx) => (
                        <div
                          key={sIdx}
                          className="bg-neutral-950 p-3 rounded-xl border border-white/5 text-xs font-mono font-bold uppercase tracking-wider text-gray-200 flex items-center gap-2"
                        >
                  ...
                  <div className="bg-neutral-900/30 border border-white/5 rounded-2xl p-5 sm:p-6 backdrop-blur-md">
                    ...
                    <div className="space-y-3">
                      {currentDiet.tips?.map((tip, idx) => (
                        <div
                          key={idx}
                          className="flex gap-3 items-start text-xs leading-relaxed text-gray-300"
                        >
              ...
              <div className="flex justify-center pt-4">
                <button
                  ...
                  className="w-full sm:w-auto bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 px-10 py-4 rounded-xl font-bold text-sm tracking-wide shadow-lg shadow-emerald-950/30 transition-all hover:scale-[1.01]"
                >
